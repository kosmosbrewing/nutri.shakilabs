...
export const seoStaticPages: SeoStaticPage[] = [
  {
    name: "Categories",
    title: "영양제 종류별 가격효율 순위 | 영양제 가격 비교 | ShakiLabs",
  ...
  {
    name: "Compare",
    title: "멀티비타민 성분·가격 나란히 비교 | 영양제 가격 비교 | ShakiLabs",
  ...
  {
    name: "Methodology",
    title: "가격당 영양효율 점수 계산법 | 영양제 가격 비교 | ShakiLabs",
  ...
  {
    name: "Sources",
    title: "영양제 가격 비교 데이터 출처 | 영양제 가격 비교 | ShakiLabs",
  ...
  {
    name: "About",
    title: "운영 정보와 데이터 검증 절차 | 영양제 가격 비교 | ShakiLabs",
  ...
  {
    name: "Privacy",
    title: "개인정보 처리 안내 | 영양제 가격 비교 | ShakiLabs",
  ...
  {
    name: "Terms",
    title: "이용약관 | 영양제 가격 비교 | ShakiLabs",
  ...
  {
    name: "Disclosure",
    title: "광고·제휴 공개 원칙 | 영양제 가격 비교 | ShakiLabs",
